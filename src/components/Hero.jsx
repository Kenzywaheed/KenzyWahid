    ...
    <section id="home" className="section container flex-center text-center">
      <div className="fade-in">
        ...
        <div className="btn-group flex-center">
          ...
          <a href="/CV KenzyWahidMohamed.pdf" download="CV KenzyWahidMohamed.pdf" className="btn btn-secondary hover-lift" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
